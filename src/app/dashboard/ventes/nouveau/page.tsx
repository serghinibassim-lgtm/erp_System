...
export default function NouvelleVentePage() {
  ...
  const availStock = selectedProduct?.stock?.stockActuel ?? 0;
        ...
        <div className="px-4 pb-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input id="numeroVente" name="numeroVente" placeholder="V-001" value={form.numeroVente} onChange={handleChange} className="h-9 w-full min-w-0 rounded-lg border border-input bg-transparent px-3 py-1.5 text-base transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50" />
            </div>
